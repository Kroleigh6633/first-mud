...
| worktree-agent-acc06476 | ready-to-merge | 157d602 (scaffold) on content-layer-pilot | Auto-craft sub-mode: AutoCraftPlanner + AutoCraftExecutor, wires Gear dispatch in AutoProgressionService (craft + auto-equip, or fall-through to Farm with zone hint), auto-craft-progress playbook (all cells on-band) + smoke tests. +14 main tests (443 total passing), +2 design-tools tests (38 total). | - | src/FirstMud.Application/Services/AutoCraftPlanner.cs, src/FirstMud.Application/Services/AutoCraftExecutor.cs, src/FirstMud.Application/Services/AutoProgressionService.cs, src/FirstMud.Application/ServiceExtensions.cs, tools/design/playbooks/auto-craft-progress.json, tests | 2026-04-13 |
