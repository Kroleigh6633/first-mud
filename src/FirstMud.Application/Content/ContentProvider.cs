...
public sealed class ContentProvider : IContentProvider
{
    ...
    public void Reload()
    {
        ...
        _logger?.LogInformation(
            "ContentProvider loaded: {ConsumableCount} consumables, {BuildingCount} buildings, {RecipeCount} recipes from {Root}",
            _consumables.Count, _buildings.Count, _recipes.Count, _contentRoot);
    }
